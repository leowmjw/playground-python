...
a = CurrentShapefile('./source/Kedah/02_Kdh_13_Ori.shp')
# Need to extract thigns out
a.extract_feature_map()
...
# after we extract out the csv??
ec = ECRecommendation('./source/Kedah/Kedah.csv')
ec.extractdata()
ec.find_dm_match(a)
# a.pprint_new_feature_map()

# Write out the new output ..
msf = ModifiedShapefile(a.shapefile_source.driver, a.shapefile_schema, './results/Kedah/02-Kedah-New-DM')
# Uncomment below to write to actual shapefile ..
msf.writeshapefile(a.get_new_feature_map())
